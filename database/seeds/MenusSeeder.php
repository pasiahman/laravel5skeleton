                        ...
                        [
                            ...
                            'children' => [
                                ...
                                [
                                    'url' => 'backend/themes',
                                    'type' => 'custom_link',
                                    'title' => CustomLinks::search(['name' => 'theme'])->firstOrFail()->title,
                                    'permission' => Permission::where('name', 'backend theme')->firstOrFail()->id,
                                    'id' => CustomLinks::search(['name' => 'theme'])->firstOrFail()->id,
                                    'icon' => 'fa fa-circle-o',
                                ], 
                            ],
                        ],
