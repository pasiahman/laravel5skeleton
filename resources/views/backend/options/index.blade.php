...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <a class="btn btn-default" href="{{ route('backend.options.create') }}">@lang('cms.create')</a>
        </div>
                    ...
                    <tbody>
                        @forelse ($options as $i => $option)
                            <tr>
                                ...
                                <td>{{ $option->value }}</td>
                                <td align="center">
                                    <a class="btn btn-default btn-xs" href="{{ route('backend.options.edit', $option->id) }}"><i class="fa fa-pencil"></i></a>
