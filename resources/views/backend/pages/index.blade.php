...
@section('content_header', __('cms.pages'))
@section('breadcrumb')
    <ol class="breadcrumb">
        <li class="active">@lang('cms.pages')</li>
    </ol>
@endsection
...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <a class="btn btn-default btn-sm" href="{{ route('backend.pages.create', request()->query()) }}">@lang('cms.create')</a>
        </div>
                        ...
                        @forelse ($posts as $i => $post)
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a class="btn btn-danger btn-xs" href="{{ route('backend.pages.trash', $post->id) }}" onclick="return confirm('@lang('cms.are_you_sure_to_delete_this')?')"><i class="fa fa-trash-o"></i></a>
                                    @can('backend pages delete')
                                        <a class="btn btn-danger btn-xs" href="{{ route('backend.pages.delete', $post->id) }}" onclick="return confirm('@lang('cms.are_you_sure_to_delete_this_permanently')?')"><i class="fa fa-trash-o"></i></a>
                                    @endcan
                                </td>
                            </tr>
                        @empty
