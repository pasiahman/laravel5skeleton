...
@section('title', __('cms.posts'))
@section('content_header', __('cms.posts'))
@section('breadcrumb')
    <ol class="breadcrumb">
        <li class="active">@lang('cms.posts')</li>
    </ol>
@endsection
...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <a class="btn btn-default btn-sm" href="{{ route('backend.posts.create', request()->query()) }}">@lang('cms.create')</a>
        </div>
                        ...
                        @forelse ($posts as $i => $post)
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a class="btn btn-danger btn-xs" href="{{ route('backend.posts.trash', $post->id) }}" onclick="return confirm('@lang('cms.are_you_sure_to_delete_this')?')"><i class="fa fa-trash-o"></i></a>
                                    @can('backend posts delete')
                                        <a class="btn btn-danger btn-xs" href="{{ route('backend.posts.delete', $post->id) }}" onclick="return confirm('@lang('cms.are_you_sure_to_delete_this_permanently')?')"><i class="fa fa-trash-o"></i></a>
                                    @endcan
                                </td>
                            </tr>
                        @empty
