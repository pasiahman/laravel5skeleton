                        ...
                        @forelse ($categories as $i => $category)
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a class="btn btn-danger btn-xs" href="{{ route('backend.medium-categories.delete', $category->id) }}" onclick="return confirm('@lang('cms.are_you_sure_to_delete_this')?')"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
