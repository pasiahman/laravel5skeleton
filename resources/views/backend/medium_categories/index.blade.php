...
@section('title', __('cms.medium_categories'))
@section('content_header', __('cms.medium_categories'))
@section('breadcrumb')
    <ol class="breadcrumb">
        <li class="active">@lang('cms.medium_categories')</li>
    </ol>
@endsection
...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <a class="btn btn-default btn-sm" href="{{ route('backend.medium-categories.create', request()->query()) }}">@lang('cms.create')</a>
        </div>
            ...
            <form action="{{ route('backend.categories.index') }}" method="get">
                <table class="table table-bordered table-condensed table-striped">
                        ...
                        @forelse ($categories as $i => $category)
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a class="btn btn-danger btn-xs" href="{{ route('backend.medium-categories.delete', $category->id) }}" onclick="return confirm('@lang('cms.are_you_sure_to_delete_this_permanently')?')"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td align="center" colspan="8">{{ $categories->appends(request()->query())->links('vendor/pagination/default-2') }}</td>
                        </tr>
                    </tfoot>
                </table>
            </form>
